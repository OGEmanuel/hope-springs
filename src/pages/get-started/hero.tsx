...
const GetStartedHero = () => {
  return (
    <section className="flex justify-center pt-18 pb-30">
      <div className="flex w-full max-w-360 flex-col items-center gap-22 px-30">
        <Heading
          ...
          variant="h1"
        />
        <div className="bg-extra-2 flex w-full flex-col gap-30 rounded-[8px] p-20 text-white shadow-[0px_28px_48px_0px_#05201026]">
          {steps.map(step => (
            <div key={step.id} className="flex w-full items-center gap-24.5">
              <span className="w-full max-w-31 text-5xl/[56px] font-medium">
                0{step.id}.
              </span>
              <span className="bg-primary block w-px self-stretch"></span>
              <Heading
                header={step.title}
