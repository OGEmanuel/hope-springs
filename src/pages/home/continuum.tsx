...
const continuumData = [
  {
    ...
    img: 'https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317267/continuum-1_qtics9.webp',
    ...
    subImg:
      'https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317267/continuum-2_bbvaon.webp',
  },
  {
    id: 2,
    header: 'Virtual IOP',
    ...
    img: 'https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317267/continuum-4_wtahdt.webp',
    ...
    subImg:
      'https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317267/continuum-3_odxfac.webp',
  },
  {
    id: 3,
    ...
    img: 'https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317268/continuum-5_klbhpz.webp',
    ...
    subImg:
      'https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317268/continuum-6_wtrk2a.webp',
  },
];
  ...
  return (
    <div className="flex gap-10 max-lg:flex-col lg:gap-6 lg:odd:flex-row-reverse">
      <div className="flex w-full flex-col gap-5 lg:w-max lg:max-w-174.25 lg:gap-13.25">
        <div className="h-60 w-full overflow-hidden rounded-[8px] bg-white sm:h-80 md:h-120">
          <img src={data.img} alt="img" className="size-full object-cover" />
        </div>
      ...
      <div className="lg:px-10">
        <div className="flex w-full flex-col gap-5 lg:w-max lg:max-w-100 lg:gap-13.25">
          <div className="h-60 w-full overflow-auto rounded-[8px] bg-white sm:h-80 md:max-lg:h-120">
            <img
              src={data.subImg}
              alt="sub-img"
