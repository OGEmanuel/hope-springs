...
const BorderedContent = (props: BorderedContentProps) => {
  ...
  return (
    <div className="border-border flex items-center gap-10 self-stretch rounded-[8px] max-lg:flex-col lg:border lg:p-10">
      <div className="h-60 w-full overflow-hidden rounded-[8px] bg-[#D9D9D9] sm:h-90 md:h-100 lg:h-140 lg:max-w-140">
        <img
          src="https://res.cloudinary.com/dl56ef7sx/image/upload/v1774317267/bordered-content-img_nouac5.webp"
          alt="bordered-content-img"
